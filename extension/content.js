...
// LINE_NOISE_PATTERN moved to lib/extract.js (used by denoiseLines, also moved).
...
// denoiseLines moved to lib/extract.js (cleanReadableText, above, still calls it).

function visibleText() {
  return cleanReadableText(pickContentRoot(), 9000);
}

// GENERIC_JOB_IDENTITY_RE / isGenericJobIdentity / cleanRole moved to lib/extract.js
...
// findSalary / findLevel moved to lib/extract.js
...
// clean / escapeHtml / escapeRegExp / PLACEHOLDER_URL_RE / isPlaceholderUrl
// moved to lib/extract.js (loaded before this file in the manifest, so the names
// stay defined in the shared content-script scope).
...
// normalizeChoiceText / isGenericChoiceValue / choiceValueMeansYes / choiceValueMeansNo
// / optionLooksYes / optionLooksNo moved to lib/extract.js
...
// tokensInclude / isPlaceholderOptionText moved to lib/extract.js
// (findBestSelectOptionIndex, below, still calls them).
...
// scoreOptionEntries moved to lib/extract.js (findBestSelectOptionIndex and the
// combobox option matcher still call it).
